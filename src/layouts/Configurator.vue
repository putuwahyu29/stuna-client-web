    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div class="" :class="'float-start'">
          <h5 class="mt-3 mb-0">Stuna Konfigurasi</h5>
          <p>Lihat konfigurasi dasbor anda.</p>
        </div>
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <p class="mt-2 text-sm d-xl-none d-block">
          Anda dapat mengubah jenis sidenav hanya pada tampilan desktop.
        </p>
        <!-- Navbar Fixed -->
        <!-- Navbar Fixed -->
        <div class="mt-3 d-flex">
          <h6 class="mb-0">Fix Navbar</h6>
